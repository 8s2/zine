...
public class ConnectedTexturesSpriteSource implements SpriteSource {
    ...
    ).apply(instance, ConnectedTexturesSpriteSource::new));
    ...
    public ConnectedTexturesSpriteSource(Identifier baseName,
    ...
    public ConnectedTexturesSpriteSource(Identifier baseName,
        ...
        this(
                baseName,
                allTexture.orElseGet(() -> baseName.withSuffix("_all")),
                cornersTexture.orElseGet(() -> baseName.withSuffix("_corners")),
                horizontalTexture.orElseGet(() -> baseName.withSuffix("_horizontal")),
                noneTexture.orElseGet(() -> baseName.withSuffix("_none")),
                verticalTexture.orElseGet(() -> baseName.withSuffix("_vertical"))
        );
    }
    ...
    public void run(ResourceManager resourceManager, Output regions) {
        ...
        for(ConnectedShape shape : ConnectedShape.values()) {
            TextureData textureData = SpriteSourceUtil.open(resourceManager, this.getTexture(shape));
        ...
        FrameSize dimensions = data.get(ConnectedShape.ALL).getDimensions();
